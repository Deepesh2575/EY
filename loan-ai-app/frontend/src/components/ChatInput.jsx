...
function ChatInput({ onSend, onFileUpload, isLoading, uploadedFiles: externalUploadedFiles = {} }) {
  const [inputValue, setInputValue] = useState('')
  const [uploadedFiles, setUploadedFiles] = useState(externalUploadedFiles)
