...
interface Application {
  ...
  type: string;
  score: number;
  status: 'APPROVED' | 'REJECTED' | 'IN_PROGRESS' | 'None';
}
    ...
    const fetchData = async () => {
        try {
            const [statsRes, appsRes] = await Promise.all([
                axios.get<Stats>(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/stats`),
                axios.get<Application[]>(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/admin/applications`)
            ])
            ...
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <StatCard
                        ...
                        value={`₹${((stats?.approved_loans || 0) * 500000 / 10000000).toFixed(1)}Cr`} // Mock calculation
